...
const HostProfile = () => {
  ...
  const handleVideoClick = (
    ...
    // stop background video immediately
    video.pause();
    video.currentTime = 0;
              ...
              <div className="col-lg-10 col-xl-10 col-md-6 col-lg-8 col-12">
                ...
                <div className="row">
                  ...
                  <div className="container inputData ">
                        ...
                        hostData.photoGallery.map((item: any, index: number) => {
                          ...
                          return (
                            <img
                              ...
                              onClick={() =>
                                  setSelectedImage(
                                    hostData?.image ? baseURL + finalUrl : "/images/male.png"
                                  )
                                }
                            />
                          );
                    ...
                    <div className="container inputData">
                    <label>
                      {hostData?.profileVideo?.length > 0 && "Host Videos"}
                    </label>
                          ...
                          (url: string, index: number) => (
                            <div key={index}>
                              <video
                                ...
                                controls
                                onClick={(e) =>
                                  handleVideoClick(e, baseURL + url)
                                }
                              />
                            </div>
                          )

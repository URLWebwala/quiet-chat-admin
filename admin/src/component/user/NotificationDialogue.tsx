                  ...
                  <div className="inputData">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setError((prev) => ({ ...prev, notificationType: e.target.value ? "" : "Gift Category is required" }));
                      }}
                    >
                      <option value="">
                        --Select Person--
                      </option>
                      {notificationTypeData?.map((data) => (

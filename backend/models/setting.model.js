...
const settingSchema = new mongoose.Schema(
  {
    ...
    bitlabsDailyLimit: { type: Number, default: 10 },
    bitlabsAppId: { type: String, default: "482cac93-7553-463c-89e1-dfc88101e03b" },
    bitlabsSecretKey: { type: String, default: "" },
    bitlabsServerKey: { type: String, default: "" },
    cpxEnabled: { type: Boolean, default: false },
    cpxPointsPerSurvey: { type: Number, default: 50 },
    cpxDailyLimit: { type: Number, default: 10 },
    cpxAppId: { type: String, default: "34491" },
    cpxSecretKey: { type: String, default: "" },
    cpxServerKey: { type: String, default: "" },
    unityAdsEnabled: { type: Boolean, default: true },
    unityPointsPerAd: { type: Number, default: 25 },
    unityDailyLimit: { type: Number, default: 10 },
    unityGameIdAndroid: { type: String, default: "" },
    unityPlacementIdAndroid: { type: String, default: "Rewarded_Android" },
    unityGameIdIos: { type: String, default: "" },

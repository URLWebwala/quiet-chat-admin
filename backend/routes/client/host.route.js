...
//get host filter options ( id + label list for date range filters )
route.get("/getHostFilterOptions", checkAccessWithSecretKey(), HostController.getHostFilterOptions);
...
//get host call stats ( audio / video / live / duration ) — shown on host profile page
route.get("/getHostCallStats", checkAccessWithSecretKey(), HostController.getHostCallStats);

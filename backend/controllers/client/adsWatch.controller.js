...
function getAdsSettings() {
  ...
  return {
    ...
    androidAdsEnabled: s.adsWatchAndroidAdsEnabled !== false,
    iosAdsEnabled: s.adsWatchIosAdsEnabled !== false,
...
function buildStatusResponse(settings, progress, ctx) {
  ...
  return {
    ...
    androidAdsEnabled: settings.androidAdsEnabled,
    iosAdsEnabled: settings.iosAdsEnabled,

...
exports.createHost = async (req, res) => {
  try {
    ...
    const newHost = new Host({
      ...
      status: 2,
      isFake: true,
      randomCallRate: req.body.randomCallRate !== undefined ? Number(req.body.randomCallRate) : settingJSON.generalRandomCallRate,
      randomCallFemaleRate: req.body.randomCallFemaleRate !== undefined ? Number(req.body.randomCallFemaleRate) : settingJSON.femaleRandomCallRate,
      randomCallMaleRate: req.body.randomCallMaleRate !== undefined ? Number(req.body.randomCallMaleRate) : settingJSON.maleRandomCallRate,
      privateCallRate: req.body.privateCallRate !== undefined ? Number(req.body.privateCallRate) : settingJSON.videoPrivateCallRate,
      audioCallRate: req.body.audioCallRate !== undefined ? Number(req.body.audioCallRate) : settingJSON.audioPrivateCallRate,
      chatRate: req.body.chatRate !== undefined ? Number(req.body.chatRate) : settingJSON.chatInteractionRate,
      useCustomCallRates: req.body.chatRate !== undefined || req.body.useCustomCallRates === "true" || req.body.useCustomCallRates === true,
